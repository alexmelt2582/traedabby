...
- 非当前账号可以手动续签：一键把登录信息有效期推后。这会让同一账号在其他设备上的副本失效，点击前会明确提示。
- 助手自带更新检查：发现新版本时“关于”页亮起小红点，可查看更新内容并直接打开下载页。
- 设置页按“签到 / 更新 / 维护”分组，避免所有配置堆在同一页。
- 关于页面向普通用户，包含助手版本、更新内容、添加 / 切换 / 迁移上手步骤和数据安全说明。
...
- 同一页还有“助手更新”：可以开关后台自动检查，也可以点“立即检查”手动查一次。只读取公开的发布信息，不涉及账号数据。
